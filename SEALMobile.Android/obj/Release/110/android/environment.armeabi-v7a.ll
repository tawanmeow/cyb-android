...
@__app_environment_variables_v_2.5 = internal constant [37 x i8] c"47986086-36a4-418e-ab2d-90784f027564\00", align 1
...
@__ApplicationConfig_android_package_name.0 = internal constant [22 x i8] c"cps.nectec.sealmobile\00", align 1
...
@application_config = local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 33555501, ; android_runtime_jnienv_class_token
	i32 100675509, ; jnienv_initialize_method_token
	i32 100675508, ; jnienv_registerjninatives_method_token
...
@__DSOCacheEntry_name.5 = internal constant [12 x i8] c"libsealc.so\00", align 1
...
@dso_cache = local_unnamed_addr global [24 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; ignore
		i8* getelementptr inbounds ([12 x i8], [12 x i8]* @__DSOCacheEntry_name.5, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 7
	%struct.DSOCacheEntry {
